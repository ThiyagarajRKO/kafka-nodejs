...
(function () {
  ...
  function Ya(d, l, Q) {
    "millisecond" === Q
      ...
      : "year" === Q && d.setFullYear(d.getFullYear() + 1 * l);
    return d;
  }
  function da(d, l) {
    var Q = !1;
  ...
  function Ga(d) {
    if (!d) return d;
    d = d.replace(/^\s\s*/, "");
    for (var l = /\s/, Q = d.length; l.test(d.charAt(--Q)); );
    return d.slice(0, Q + 1);
  }
  function za(d) {
    d.roundRect = function (d, Q, p, v, ra, E, B, t) {
      B && (this.fillStyle = B);
      ...
      this.beginPath();
      this.moveTo(d + ra, Q);
      this.lineTo(d + p - ra, Q);
      this.quadraticCurveTo(d + p, Q, d + p, Q + ra);
      this.lineTo(d + p, Q + v - ra);
      this.quadraticCurveTo(d + p, Q + v, d + p - ra, Q + v);
      this.lineTo(d + ra, Q + v);
      this.quadraticCurveTo(d, Q + v, d, Q + v - ra);
      this.lineTo(d, Q + ra);
      this.quadraticCurveTo(d, Q, d + ra, Q);
      this.closePath();
      B && this.fill();
      t && 0 < E && this.stroke();
    };
  ...
  function V(d, l, Q, v, ia) {
    v = v || [];
    ia = p(ia) ? (gb ? { passive: !1, capture: !1 } : !1) : ia;
    v.push([d, l, Q, ia]);
    return d.addEventListener
      ? (d.addEventListener(l, Q, ia), Q)
      : d.attachEvent
      ? ((v = function (l) {
          l = l || window.event;
          l.preventDefault =
  ...
  function ta(d, l, p) {
    ...
    l.getAttribute("state") !== p &&
      ...
      (l.innerHTML =
        ...
        "' />"),
      Z(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  function Ua(d, l, p, v, ia) {
    ...
    "undefined" !== typeof v &&
      ((d = Math.min(v, d)),
      "undefined" !== typeof ia && (d = Math.max(ia, d)));
  ...
  function K(d, l, v, $, ia) {
    ...
    d = {};
    this.theme && p(this.parent) && p(l) && p($)
      ...
      : this.parent &&
        ...
        (null === $
          ...
          : 0 < this.parent.themeOptions[l].length &&
            (($ = Math.min(this.parent.themeOptions[l].length - 1, $)),
            (d = this.parent.themeOptions[l][$])));
    this.themeOptions = d;
    this.options = v ? v : { _isPlaceholder: !0 };
    this.setOptions(this.options, d);
  }
  function Ea(d, l, p, v, ia) {
  ...
  function Aa(d, l) {
    ...
    if (p(this.options.margin) && d.options.subtitles)
      for (var v = d.options.subtitles, $ = 0; $ < v.length; $++)
        if (
          ((p(v[$].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[$].horizontalAlign === this.horizontalAlign) &&
          ((p(v[$].verticalAlign) && "top" === this.verticalAlign) ||
            v[$].verticalAlign === this.verticalAlign) &&
          !v[$].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  var Ha = !1,
    ...
    Ka = { en: {} },
    B = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
  ...
  var gb = (function () {
        ...
        return (P = H.replace(d, function (r) {
          switch (r) {
            ...
            case "K":
              return Z
                ? "UTC"
                : (String(t).match(B) || [""]).pop().replace(E, "");
            case "z":
    ...
    fa = function (d, l, p) {
        ...
        if (((l = H[N]), "." === l && 0 > I)) I = N;
          ...
          if ("%" === l) E *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (K = !0);
          0 > I
            ? (P.push(l), "#" === l || "0" === l ? V++ : "," === l && Z++)
            : (T.push(l), ("#" !== l && "0" !== l) || U++);
        }
      K &&
        ((l = Math.floor(d)),
        (H = -Math.floor(Math.log(d) / Math.LN10 + 1)),
        (O = 0 === d ? 0 : 0 === l ? -(V + H) : nb(l).length - V),
        (E /= Math.pow(10, O)));
      0 > I && (I = N);
      E = (d * E).toFixed(U);
      l = E.split(".");
      ...
      d = (l[1] + "").split("");
      E && "0" === E[0] && E.shift();
      for (K = H = N = U = I = 0; 0 < P.length; )
        if (((l = P.pop()), "#" === l || "0" === l))
          if ((I++, I === V)) {
            var Y = E,
              E = [];
            if ("0" === l)
              for (l = V - U - (Y ? Y.length : 0); 0 < l; ) Y.unshift("0"), l--;
            for (; 0 < Y.length; )
              (p = Y.pop() + p),
                K++,
                0 === K % H && N === Z && 0 < Y.length && (p = t + p);
          } else
            0 < E.length
              ? ((p = E.pop() + p), U++, K++)
              : "0" === l && ((p = "0" + p), U++, K++),
              0 === K % H && N === Z && 0 < E.length && (p = t + p);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (N++, (H = K), (K = 0), 0 < E.length && (p = t + p))
              : (p =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Na = 1,
    ma = bb ? Ta / Na : 1,
    ba = function (d, l, p, v, t, B, E, H, I, P, T, U, V) {
      "undefined" === typeof V && (V = 1);
      E = E || 0;
      H = H || "black";
      var K = 15 < v - l && 15 < t - p ? 8 : 0.35 * Math.min(v - l, t - p);
      d.beginPath();
      d.moveTo(l, p);
      d.save();
      d.fillStyle = B;
      ...
      0 < E &&
        ...
        (d.strokeStyle = H),
        d.moveTo(l, p),
        d.rect(l - V, p - V, v - l + 2 * V, t - p + 2 * V),
        d.stroke());
      d.restore();
      !0 === I &&
        (d.save(),
        ...
        d.lineTo(v, p),
        d.closePath(),
        (E = d.createLinearGradient((v + l) / 2, p + K, (v + l) / 2, p)),
        E.addColorStop(0, B),
      ...
      !0 === P &&
        ...
        d.lineTo(v, t),
        d.closePath(),
        (E = d.createLinearGradient((v + l) / 2, t - K, (v + l) / 2, t)),
        E.addColorStop(0, B),
        E.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (d.fillStyle = E),
        d.fill(),
      ...
      !0 === T &&
        ...
        d.lineTo(l, t),
        d.closePath(),
        (E = d.createLinearGradient(l + K, (t + p) / 2, l, (t + p) / 2)),
        E.addColorStop(0, B),
      ...
      !0 === U &&
        ...
        d.lineTo(v - K, t - K),
        d.lineTo(v, t),
        (E = d.createLinearGradient(v - K, (t + p) / 2, v, (t + p) / 2)),
        E.addColorStop(0, B),
        E.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (d.fillStyle = E),
        E.addColorStop(0, B),
  ...
  K.prototype.updateOption = function (d) {
    ...
    var l = qa[this._defaultsKey],
      ...
      H = this._index;
    this.theme && p(this.parent) && p(B) && p(H)
          ...
          : this.parent.themeOptions[B] &&
            (null === H
              ...
              : 0 < this.parent.themeOptions[B].length &&
                ((v = Math.min(this.parent.themeOptions[B].length - 1, H)),
  ...
  K.prototype.dispatchEvent = function (d, p, v) {
    if (d && this._eventListeners[d]) {
      ...
      for (var t = this._eventListeners[d], B = 0; B < t.length; B++)
        t[B].eventHandler.call(t[B].context, p);
    }
  ...
  ka.prototype._getLineWithWidth = function (d, p, v) {
    ...
    for (this.ctx.font = this._getFontString(); t <= B; ) {
      var H = Math.floor((t + B) / 2),
        E = d.substr(0, H + 1);
      v = this.ctx.measureText(E).width;
      if (v < p) t = H + 1;
      else if (v > p) B = H - 1;
      else break;
    }
    v > p &&
      1 < E.length &&
      ((E = E.substr(0, E.length - 1)), (v = this.ctx.measureText(E).width));
    p = !0;
    if (E.length === d.length || " " === d[E.length]) p = !1;
    p &&
      ((d = E.split(" ")),
      1 < d.length && d.pop(),
      (E = d.join(" ")),
      (v = this.ctx.measureText(E).width));
    return { text: E, width: v };
  };
    ...
    if (0 === this.frontSize) B = t = 0;
      ...
      for (; 0 < d.length; ) {
        ...
        var K = B,
          ...
          t = t + E.height,
          d = Ga(d.slice(E.text.length, d.length));
        H && t > H && ((E = p.pop()), (t -= E.height), (B = K));
      }
    this._wrappedText = { lines: p, width: B, height: t };
  ...
  Aa.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ? ((t = l.y1 + 2 + this.fontSize / 2 + 4), (I = "top"))
          ...
          "left" === this.horizontalAlign
            ...
            : "right" === this.horizontalAlign && (v = l.x2 - 2 - P.width - E),
  ...
  var Qa = {
    ...
    formatNumber: function (d, p, v) {
      v = v || "en";
      if (Ka[v]) return fa(d, p || "#,##0.##", new Ja(v));
  ...
  B = Qa.Chart = (function () {
    ...
    function O(a, e, c, b) {
      O.base.constructor.call(this, "DataSeries", "data", e, c, a);
      this.chart = a;
      this.canvas = a.canvas;
    ...
    function E(a, e, c, b, f, h) {
      E.base.constructor.call(this, "Axis", e, c, b, a);
      this.chart = a;
      this.canvas = a.canvas;
      this.ctx = a.ctx;
    ...
    function W(a, e) {
      W.base.constructor.call(this, "ToolTip", "toolTip", e, null, a);
      this.chart = a;
      this.canvas = a.canvas;
      this.ctx = this.chart.ctx;
    ...
    l.prototype.setLayout = function () {
      ...
      if (this.options.subtitles)
        for (e = 0; e < this.options.subtitles.length; e++)
          (c = new Ia(this, this.options.subtitles[e], e)),
    ...
    l.prototype.getObjectAtXY = function (a, e, c) {
      ...
      else if (v) b = ab(a, e, this._eventManager.ghostCtx);
      else
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== C && "" !== C) {
          var u = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
            ...
            A = na("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            t = m.direction,
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (d[b] = s[k].y + (d[b] ? d[b] : 0)),
                    (D = a.axisY.convertValueToPixel(d[b])),
                ...
                ba(
                  c,
                  m,
                  a.axisY.reversed ? D : q,
                  u,
                  a.axisY.reversed ? q : D,
                  b,
                  0,
                  null,
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (p[b] = s[k].y + (p[b] ? p[b] : 0)),
                    (m = r[b] ? r[b] : n),
                    (r[b] = D = a.axisY.convertValueToPixel(p[b]));
                else if (
                ...
                ba(
                  c,
                  a.axisY.reversed ? m : D,
                  q,
                  a.axisY.reversed ? D : m,
                  u,
                  b,
                  0,
                  null,
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        C &&
          ...
          h.fill(),
          (h.globalAlpha = 1),
          v && (r.lineTo(y, D), r.lineTo(C.x, D), r.closePath(), r.fill()),
          h.beginPath(),
          h.moveTo(y, s),
          r.beginPath(),
          r.moveTo(y, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          var w = 0,
            ...
            C = null;
          if (0 < l.length) {
            var A = g._colorSet[w % g._colorSet.length],
              t = (g.lineColor = g.options.lineColor || A),
              B = t;
            h.fillStyle = A;
            h.strokeStyle = t;
            ...
            if (h.setLineDash) {
              ...
              c = g.lineDashType;
              var S = H(c, g.lineThickness);
              h.setLineDash(S);
            }
            for (var ga = !0; w < l.length; w++)
              if (
                  ...
                  w < l.length - 1 &&
                    ...
                    h.setLineDash &&
                      (l[w].lineDashType
                        ...
                        : ((c = g.lineDashType), h.setLineDash(S))));
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < q.length) {
            var u = m._colorSet[n % m._colorSet.length],
              D = (m.lineColor = m.options.lineColor || u),
              C = D;
            b.fillStyle = u;
            b.strokeStyle = D;
            ...
            var A = "solid";
            if (b.setLineDash) {
              var B = H(m.nullDataLineDashType, m.lineThickness),
                A = m.lineDashType,
                E = H(A, m.lineThickness);
              b.setLineDash(E);
            }
            for (l = !1; n < q.length; n++)
              if (
                ...
                if ("number" !== typeof q[n].y)
                  ...
                  n < q.length - 1 &&
                    (C !== (q[n].lineColor || D) ||
                      A !== (q[n].lineDashType || m.lineDashType)) &&
                    ((C = q[n].lineColor || D),
                    ...
                    b.setLineDash &&
                      (q[n].lineDashType
                        ...
                        : ((A = m.lineDashType),
                          (z[z.length - 1].newLineDashArray = E))));
                  if (
                    0 !== q[n].markerSize &&
                    (0 < q[n].markerSize || 0 < m.markerSize)
                  ) {
                    var S = m.getMarkerProperties(n, g, l, b);
                    r.push(S);
                    L = T(L);
                    v &&
                      r.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < l.length) {
            ...
            var L = "solid";
            if (h.setLineDash) {
              var S = H(g.nullDataLineDashType, g.lineThickness),
                L = g.lineDashType,
                E = H(L, g.lineThickness);
              h.setLineDash(E);
            }
            for (; w < l.length; w++)
              if (
                    ...
                    w < l.length - 1 &&
                      ...
                      h.setLineDash &&
                        (l[w].lineDashType
                          ...
                          : ((L = g.lineDashType), h.setLineDash(E)))),
                    (z = g.dataPointIds[w]),
    ...
    l.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
          var C = a.dataSeriesIndexes[D],
            A = this.data[C],
            t = A.dataPoints;
          A.dataPointIndexes = [];
          for (n = 0; n < t.length; n++)
            (C = t[n].x.getTime ? t[n].x.getTime() : t[n].x),
              (A.dataPointIndexes[C] = n),
              f[C] || (m.push(C), (f[C] = !0));
          m.sort(Sa);
        }
        for (D = 0; D < a.dataSeriesIndexes.length; D++) {
          C = a.dataSeriesIndexes[D];
          A = this.data[C];
          t = A.dataPoints;
          z = !0;
          k = [];
          ...
          if (0 < m.length) {
            var f = A._colorSet[0],
              B = (A.lineColor = A.options.lineColor || f),
              L = B;
            b.fillStyle = f;
            b.strokeStyle = B;
            ...
            u = "solid";
            if (b.setLineDash) {
              var S = H(A.nullDataLineDashType, A.lineThickness);
              u = A.lineDashType;
              var E = H(u, A.lineThickness);
              b.setLineDash(E);
            }
            for (var aa = !0, n = 0; n < m.length; n++) {
              var h = m[n],
                ha = null,
                ha =
                  0 <= A.dataPointIndexes[h]
                    ? t[A.dataPointIndexes[h]]
                    : { x: h, y: null };
              if (
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  (h > a.axisX.dataInfo.viewPortMax &&
                    (!A.connectNullData || !aa))
                )
              )
                if ("number" !== typeof ha.y)
                  A.connectNullData || aa || z || e(), (aa = !0);
                else {
                  ...
                  n < t.length - 1 &&
                    (L !== (t[n].lineColor || B) ||
                      u !== (t[n].lineDashType || A.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, l),
                    k.push({ x: g, y: w - oa }),
                    ...
                    b.setLineDash &&
                      (t[n].lineDashType
                        ? ((u = t[n].lineDashType),
                          b.setLineDash(H(u, A.lineThickness)))
                        : ((u = A.lineDashType), b.setLineDash(E))));
                  ...
                  0 <= A.dataPointIndexes[h] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < A.markerSize) &&
                    ((oa = A.getMarkerProperties(
                      A.dataPointIndexes[h],
                      g,
                      l,
                      b
                    )),
    ...
    l.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (D = 0; D < a.dataSeriesIndexes.length; D++) {
          ...
          k = [];
          if (0 < m.length) {
            var f = A._colorSet[n % A._colorSet.length],
              B = (A.lineColor = A.options.lineColor || f),
              L = B;
            b.fillStyle = f;
            b.strokeStyle = B;
            ...
            for (var aa = !0, n = 0; n < m.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  n < t.length - 1 &&
                    (L !== (t[n].lineColor || B) ||
                      s !== (t[n].lineDashType || A.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, l),
                    k.push({ x: g, y: z - la }),
                    ...
                    b.setLineDash &&
                      (t[n].lineDashType
                        ? ((s = t[n].lineDashType),
                          b.setLineDash(H(s, A.lineThickness)))
                        : ((s = A.lineDashType), b.setLineDash(E))));
                  if (0 <= A.dataPointIndexes[h]) {
          ...
          if (0 < z.length)
            for (
              ...
              if (
                ...
                "candlestick" === s.type
                  ? (c.moveTo(l - B, m),
                    c.lineTo(l - B, Math.min(k, n)),
                    c.stroke(),
                    c.moveTo(l - B, Math.max(k, n)),
                    c.lineTo(l - B, q),
                    c.stroke(),
                    ba(
                      c,
                    ...
                    v &&
                      ...
                      (b.strokeStyle = f),
                      b.moveTo(l - B, m),
                      b.lineTo(l - B, Math.min(k, n)),
                      b.stroke(),
                      b.moveTo(l - B, Math.max(k, n)),
                      b.lineTo(l - B, q),
                      b.stroke(),
                      ba(
                        b,
                ...
                (z[d].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: z[d],
                    dataSeries: s,
                    point: { x: D + (C - D) / 2, y: a.axisY.reversed ? q : m },
                    direction: 1,
                    bounds: {
                      x1: D,
                      y1: Math.min(m, q),
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < u.length)
            for (
              var D = 5 < t && z.bevelEnabled ? !0 : !1, r = 0;
              r < u.length;
              r++
            )
              if (
                ...
                var C = (d - t / 2) << 0,
                  ...
                  P =
                    "number" === typeof u[r].lineThickness
                      ...
                      ? z.lineThickness
                      : B,
                  V = u[r].lineDashType ? u[r].lineDashType : z.lineDashType,
                ...
                0 < P &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(H(V, P)),
                  (c.strokeStyle = K),
                  (c.lineWidth = P),
                  c.moveTo(C, n - M),
                  c.lineTo(A, n - M),
                ...
                0 < S &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(H(ga, S)),
                  (c.strokeStyle = L),
                  (c.lineWidth = S),
                ...
                v &&
                  ...
                  0 < la &&
                    (b.moveTo(d - E - F, k),
                    b.lineTo(d - E - F, Math.max(l, q)),
                    b.stroke(),
                    b.moveTo(d - E - F, Math.min(l, q)),
                    b.lineTo(d - E - F, m),
                    b.stroke()),
                  ba(
                    b,
                ...
                (u[r].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: u[r],
                    dataSeries: z,
                    point: { x: C + (A - C) / 2, y: a.axisY.reversed ? l : q },
                    direction: 1,
                    bounds: {
                      x1: C,
                      y1: Math.min(l, q),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          var u = a.dataSeriesIndexes[z],
            ...
            E = 0;
          if (A)
            for (f = D._linkedSeries.id, s = 0; s < f; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                !this.data[s].visible ||
                (this.data[s].type.match(/(stacked)/gi) && E) ||
                (this.data[s].type.match(/(range)/gi) && (h = !0), E++);
          f = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          d = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (A ? y : 1))
              ) << 0
            : 0.3 * this.width;
          h &&
            (d = this.options.dataPointMaxWidth
          ...
          s > d && (s = d);
          if (0 < C.length)
            for (var H = D._colorSet, d = 0; d < C.length; d++) {
              var f = (D.lineColor = D.options.color ? D.options.color : H[0]),
                L = {
              ...
              if (
                ...
                b
                  ? ((n = a.axisX.reversed
                      ? (k + ((A ? y : 1) * s) / 2 - (A ? E - 1 : 0) * s) << 0
                      : (k - ((A ? y : 1) * s) / 2 + (A ? E - 1 : 0) * s) << 0),
                    (g = a.axisX.reversed ? (n - s) << 0 : (n + s) << 0))
                  : ((m = a.axisX.reversed
                      ? (l + ((A ? y : 1) * s) / 2 - (A ? E - 1 : 0) * s) << 0
                      : (l - ((A ? y : 1) * s) / 2 + (A ? E - 1 : 0) * s) << 0),
                ...
                v && B(this._eventManager.ghostCtx, m, n, q, g, f, L, S, b);
                if (
                  C[d].indexLabel ||
                  D.indexLabel ||
            ...
            for (var L = !0; g < q.length; g++)
              if (
                ...
                if (
                  ...
                  n || L
                    ? (m.connectNullData && !n
                        ? (b.setLineDash &&
                            ...
                            ((p[p.length - 1].newLineDashArray = E),
                            (A = m.nullDataLineDashType),
                            b.setLineDash(B)),
                          b.lineTo(l, w),
                          v && f.lineTo(l, w),
                  ...
                  g < q.length - 1 &&
                    (C !== (q[g].lineColor || t) ||
                      A !== (q[g].lineDashType || m.lineDashType)) &&
                    (e(),
                    (C = q[g].lineColor || t),
                  ...
                  if (
                    ...
                    var S = m.getMarkerProperties(g, l, y, b);
                    h.push(S);
                    var ga = T(s);
                    v &&
                      h.push({
                    ...
                    S = m.getMarkerProperties(g, l, w, b);
                    h.push(S);
                    ga = T(s);
                    v &&
                      h.push({
            ...
            for (g = !1; q < m.length; q++)
              if (
                ...
                if (
                  ...
                  q < m.length - 1 &&
                    (u !== (m[q].lineColor || z) ||
                      D !== (m[q].lineDashType || k.lineDashType)) &&
                    ((u = m[q].lineColor || z),
                  ...
                  if (
                    ...
                    var E = k.getMarkerProperties(q, n, g, b);
                    h.push(E);
                    var L = T(B);
                    v &&
                      h.push({
                    ...
                    E = k.getMarkerProperties(q, n, l, b);
                    h.push(E);
                    L = T(B);
                    v &&
                      h.push({
              ...
              if (
                ...
                d = a.axisX.reversed
                  ...
                  : (d -
                      ...
                      (a.previousDataSeriesCount + g) * n) <<
                    0;
                var E = a.axisX.reversed ? (d - n) << 0 : (d + n) << 0;
                p > k && ((f = p), (p = k), (k = f));
                ...
                ba(
                  c,
                  a.axisX.reversed ? E : d,
                  a.axisY.reversed ? k : p,
                  a.axisX.reversed ? d : E,
                ...
                0 < r &&
                  C &&
                  (!t || w.connectNullData) &&
                  (t && c.setLineDash && c.setLineDash(H(B, s)),
                  c.beginPath(),
                  c.moveTo(C, A - z),
                  c.lineTo(L, S - z),
                  0 < s && c.stroke(),
    ...
    var qa = function (a, e, c, b, f, h, r, d, p) {
      if (!(0 > c)) {
            ...
            for (var p, s, a = 0; a < m.length; a++) {
              ...
              if (null !== x) {
                ...
                var t = 0,
                  t = b(p, s) - v;
                if (0 > t) {
                  for (var C = (s = 0), D = 0; D < m.length; D++)
                    D !== a &&
                      g[D].hemisphere === d.hemisphere &&
                      (g[D].indexLabelTextBlock.y < d.indexLabelTextBlock.y
                        ? s++
                        : C++);
                  s = (t / (s + C || 1)) * C;
                  var C = -1 * (t - s),
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function b() {
        if (s && z) {
          ...
          for (var A = 0, D = z.length - 1; A < z.length || 0 <= D; A++, D--) {
            b = s.reversed ? z[D] : z[A];
            a = b.color
              ? b.color
              : s.reversed
              ? s._colorSet[(z.length - 1 - A) % s._colorSet.length]
              : s._colorSet[A % s._colorSet.length];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? y.replaceKeywordsWithValue(b.indexLabel, b, s, A)
              : s.indexLabelFormatter
              ? s.indexLabelFormatter(C)
              : s.indexLabel
              ? y.replaceKeywordsWithValue(s.indexLabel, b, s, A)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
        ...
        if (e)
          for (r = G.length - 1; 0 <= r; r--)
            (a = R[r]),
              ...
              s.reversed
                ? (G[r].textBlock.y + G[r].height > W + D &&
                    (G[r].textBlock.y = W + D - G[r].height),
                  G[r].textBlock.y < ua - D && (G[r].textBlock.y = ua - D))
                : (G[r].textBlock.y < W - D && (G[r].textBlock.y = W - D),
                  G[r].textBlock.y + G[r].height > ua + D &&
                    (G[r].textBlock.y = ua + D - G[r].height));
      }
      function h() {
        var a, b, c, f;
          ...
          for (var e = 0; e < R.length; e++)
            0 == G[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                s.reversed
                  ? (G[e].textBlock.y + G[e].height > W + D &&
                      (G[e].textBlock.y = W + D - G[e].height),
                    G[e].textBlock.y < ua - D && (G[e].textBlock.y = ua - D))
                  : (G[e].textBlock.y < W - D && (G[e].textBlock.y = W - D),
                    G[e].textBlock.y + G[e].height > ua + D &&
                      (G[e].textBlock.y = ua + D - G[e].height)));
        else
          ...
          for (var r, k = 1; k < d; k++) {
            ...
            for (var p = G.length - 1; 0 <= p; p--)
              !G[p].isDirty &&
                ...
                ((r = n(p)),
                !(r >= G.length - 1) &&
                  G[p].textBlock.y + G[p].height + ea > G[r].textBlock.y &&
                  (G[p].textBlock.y =
      ...
      function l(a, b) {
        return (
          (b < R.length ? G[b].textBlock.y : s.reversed ? W + D : ua + D) -
          (0 > a
            ? s.reversed
              ? ua - D
              : W - D
      ...
      function t(a, b, c) {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (f = 0; f < R.length; f++) sa(e, R[f], s.fillOpacity);
            w(e);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!L &&
              "undefined" !== typeof z[S].indexLabel &&
              null !== z[S].indexLabel &&
              0 < z[S].indexLabel.toString().length &&
              (L = !0),
            !L &&
              "undefined" !== typeof z[S].label &&
              null !== z[S].label &&
              0 < z[S].label.toString().length &&
              (L = !0),
            (!L && "function" === typeof s.indexLabelFormatter) ||
              "function" === typeof z[S].indexLabelFormatter)
          )
            L = !0;
        L =
          L ||
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== z.length) {
          ...
          var T = (30 * (K - a)) / 100;
          "funnel" === s.type
            ? ((O = p(s.options.neckHeight) ? 0.35 * E : s.neckHeight),
          ...
          if (-1 !== S) {
            if (s.reversed)
              for (I.push(ba), F = S.length - 1; 0 < F; F--)
                (ba += S[F]), I.push(ba);
            else for (F = 0; F < S.length; F++) (ba += S[F]), I.push(ba);
            if (s.reversed)
              for (F = 0; F < S.length; F++)
                I[F] < Y
                  ? (a.push(M), C.push($), (da = F))
                  : (a.push((I[F] - W + ca * U) / ca),
                    C.push((I[F] - W + fa * Z) / fa));
            else
              for (F = 0; F < S.length; F++)
                I[F] < Y
                  ? (a.push((I[F] - W + ca * U) / ca),
            ...
            for (F = 0; F < z.length; F++)
              z[F].exploded &&
                ((S = !0), s.reversed ? X.push(z.length - 1 - F) : X.push(F));
            Q.clearRect(u.x1, u.y1, u.width, u.height);
            Q.fillStyle = y.backgroundColor;
            Q.fillRect(u.x1, u.y1, u.width, u.height);
            if (
              L &&
              s.visible &&
              ...
              for (F = 0; F < R.length; F++)
                (R[F].x1 += A),
                  ...
                  (R[F].x3 += A),
                  (R[F].x4 += A),
                  R[F].x5 && ((R[F].x5 += A), (R[F].x6 += A)),
                  (G[F].textBlock.x += A);
            }
            for (F = 0; F < R.length; F++)
              (A = R[F]), sa(Q, A, s.fillOpacity), ja.push(A.y1);
            w(Q);
            L &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || m(Q),
    ...
    l.prototype.replaceKeywordsWithValue = function (a, e, c, b, f) {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          g && 0 < g.length && ((d = Ga(g[2])), (a = Ga(g[1])));
        } catch (r) {}
        g = null;
        if ("color" === a)
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : O.getDefaultLegendMarker(q._linkedSeries.type)
                  : O.getDefaultLegendMarker(q.type)
                : q.markerType),
              g = q.legendText
                ? q.legendText
    ...
    O.prototype.getDataPointAtX = function (a, e) {
    ...
    O.prototype.getDataPointAtXY = function (a, e, c) {
      if (
        !this.dataPoints ||
    ...
    O.prototype.getMarkerProperties = function (a, e, c, b) {
    ...
    E.setLayout = function (a, e, c, b, f, h) {
      var d,
        l,
        t,
        k,
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? B + s > t &&
                      (l += 0 < a[g].labelAngle ? B + s - t - $ : 0)
                    : 0 > a[g].labelAngle
                    ? A - y < d &&
                      A - y < a[g].viewportMinimum &&
                      (E =
                        d -
                        (M +
                          a[g].tickLength +
                  ...
                  0 < l
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < E && (d += E), 0 < l && (t -= l))),
                m.panEnabled
                  ? (X = p(m.sessionVariables.axisX.height)
            ...
            for (g = 0; g < e.length; g++)
              (e[g].lineCoordinates.x1 = Math.round(h.x1 + R + M)),
                ...
                m.panEnabled
                  ...
                  : (m.sessionVariables.axisX2.height = Y),
                (l = Math.round(h.y1)),
                (k = e[g].lineCoordinates.y1 = l + Y + W - V),
        ...
        for (P = []; 4 > w; ) {
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((l = Math.round(h.y1)),
                (k = Math.round(h.y1 + (A[g] + b[g].margin + F))),
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((t = b[M].lineCoordinates.x1), (d = t - U));
              a[g].lineCoordinates = {
                x1: t - O,
                y1: l,
                x2: t - O,
    ...
    E.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (f = b || !p(e[h].options.spacing)),
          (e[h].spacing =
            Ua(e[h].spacing, a, 8, f ? 0.1 * a : 8, f ? 0 : 3) << 0),
    ...
    E.prototype.renderCrosshair = function (a, e) {
    ...
    E.prototype.getApparentDifference = function (a, e, c, b) {
    ...
    E.prototype.setViewPortRange = function (a, e) {
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * U.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        E.getNiceNumber(b / (a - 1), !0) / U.yearDuration
                      )),
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      d = Math.pow(
        this.logarithmBase,
        E.getNiceNumber(Math.abs(Math.log(d) / e), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = E.getNiceExponent(Math.log(d) / e / (a - 1), !0)),
          (c = E.getNiceNumber(l / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(h)
    ...
    E.generateValueFormatString = function (a, e) {
      var c = "#,##0.",
        b = e;
      1 > a &&
    ...
    E.getNiceExponent = function (a, e) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = Infinity, u, s = 0; s < m.length; s++) {
            if (
              ...
              if (m[s].dataPoint.y)
                for (var D = 0; D < m[s].dataPoint.y.length; D++)
                  (z = Math.abs(
                    a - this.parent.convertValueToPixel(m[s].dataPoint.y[D])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
          ...
          for (s = 0; s < m.length; s++) {
            if (
              ...
              if (m[s].dataPoint.y)
                for (D = 0; D < m[s].dataPoint.y.length; D++)
                  (z = Math.abs(
                    e - this.parent.convertValueToPixel(m[s].dataPoint.y[D])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
    ...
    W.prototype.mouseMoveHandler = function (a, e) {
    ...
    W.prototype._updateToolTip = function (a, e, c) {
      c = "undefined" === typeof c ? !0 : c;
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          var t = [];
          if (this.chart.axisX)
            for (var B = 0; B < this.chart.axisX.length; B++) {
              for (
                var l =
                    "xySwapped" === this.chart.plotInfo.axisPlacement
                      ? this.chart.axisX[B].convertPixelToValue({ y: e })
                      : this.chart.axisX[B].convertPixelToValue({ x: a }),
                  k = null,
                  b = 0;
                b < this.chart.axisX[B].dataSeries.length;
                b++
              )
                (k = this.chart.axisX[B].dataSeries[b].getDataPointAtX(l, c)) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX[B].dataSeries[b]),
                  null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
              k = null;
            }
          if (this.chart.axisX2)
            for (B = 0; B < this.chart.axisX2.length; B++) {
              l =
                "xySwapped" === this.chart.plotInfo.axisPlacement
                  ? this.chart.axisX2[B].convertPixelToValue({ y: e })
                  : this.chart.axisX2[B].convertPixelToValue({ x: a });
              k = null;
              for (b = 0; b < this.chart.axisX2[B].dataSeries.length; b++)
                (k = this.chart.axisX2[B].dataSeries[b].getDataPointAtX(
                  l,
                  c
                )) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX2[B].dataSeries[b]),
                  null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
              k = null;
            }
          ...
          if ((b = this.chart.getDataPointAtXY(a, e, c)))
            ...
            if (
              ((b = ab(a, e, this.chart._eventManager.ghostCtx)),
              0 < b &&
        ...
        if (
          ...
          !1 === d.highlightEnabled ||
            ...
            "rangeSplineArea" === b.type
              ...
              ? sa(e, f.funnelSection, 0.3, "white")
              : "candlestick" === b.type
              ? ((e.globalAlpha = 1),
    ...
    W.prototype.show = function (a, e, c) {
      this._updateToolTip(a, e, "undefined" === typeof c ? !1 : c);
    };
    W.prototype.showAtIndex = function (a, e) {};
    W.prototype.showAtX = function (a, e) {
      if (!this.enabled) return !1;
      this.chart.clearedOverlayedCanvas = null;
      var c,
        b,
    ...
    W.prototype.fixMozTransitionDelay = function (a, e) {
    ...
    X.prototype.fireEvent = function (a, e, c) {
      if (a && e) {
