...
(function (root, factory) {
  ...
  var animator = function animator(easing, startValue, valueChange, dur, cb) {
    var easeFunc =
      typeof easing === "string" ? animator.easings[easing] : easing;
    var tStart;
    ...
    var CircleProgress = /*#__PURE__*/ (function () {
      ...
      function CircleProgress(el) {
        ...
        this.graph.sector = this.graph.paper.element("path").attr({
          d: CircleProgress._makeSectorPath(
            50,
            50,
      ...
      _createClass(
        ...
        [
          ...
          },
          {
            ...
            value: function _set(key, val) {
              ...
              if (key in ariaAttrs) {
                if (val !== undefined)
                  this.el.setAttribute(ariaAttrs[key], val);
          ...
          },
          {
            ...
            value: function _valueToAngle() {
              ...
              return Math.min(
                360,
                Math.max(0, ((value - this.min) / (this.max - this.min)) * 360)
              );
            },
            /**
          ...
          },
          {
            ...
            value: function _initText() {
                ...
                case "valueOnCircle":
                  this.graph.textVal = this.graph.paper.element(
                    "tspan",
                    {
                      ...
                      "font-size": "12",
                      fill:
                        this.textFormat === "valueOnCircle" ? "#fff" : "#888",
                    },
                    "",
                    this.graph.text
                  );
              ...
              if (this.textFormat !== "vertical") {
                if (this.graph.text.el.hasAttribute("dominant-baseline"))
                  this.graph.text.attr("dominant-baseline", "central"); // IE
                ...
                if (
                  ...
                  animator(
                    ...
                    function (value) {
                      _this2._updateText(
                        Math.round(value),
                        (2 * startAngle + angle) / 2,
                        r
                      );

                      angle = _this2._valueToAngle(value);

                      _this2.graph.sector.attr(
                        "d",
            ...
            value: function _updateText(value, angle, r) {
              if (typeof this.textFormat === "function") {
                ...
                this.graph.text.el.textContent =
                  value !== undefined ? value : this.indeterminateText;
              } else if (this.textFormat === "percent") {
                this.graph.text.el.textContent =
                  (value !== undefined && this.max != null
                    ? Math.round((value / this.max) * 100)
        ...
        [
          {
            key: "_makeSectorPath",
            value: function _makeSectorPath(
              cx,
              cy,
              r,
              startAngle,
